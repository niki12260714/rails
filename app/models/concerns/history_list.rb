class HistoryList
  ...
  attr_accessor :pass_item, :pass_bad_item, :pass_sum, :receive_item, :receive_bad_item, :receive_sum, :target_user, :pass_item_price, :receive_item_price
